...
El informe monográfico de recursos humanos del SNS de 2024 contabiliza 2.418 fisioterapeutas en AP [@B1]. Según el mismo informe, el 84,8 % de los fisioterapeutas del SNS trabaja en hospitales y el 10 % en AP [@B1]. El reparto muestra que la fisioterapia pública se concentra en el nivel hospitalario.

La dotación de AP varía mucho entre comunidades autónomas. Un editorial de la revista Fisioterapia recogió en 2022 los habitantes por fisioterapeuta de AP según el Sistema de Información de Atención Primaria (SIAP) [@B7]. La tabla 3.1 resume los valores extremos que publicó [@B7].
...
|---|---|---|---|---|---|
| Andalucía | Cartera de servicios de AP y circuito de derivación directa del Servicio Andaluz de Salud [@C1b; @C1] | 2026 | Sí | Sí, para seis procesos | No |
| Aragón | Cartera de Servicios de Atención Primaria del Gobierno de Aragón [@C2] | 2024 | Sí | Sin protocolo localizado | No |
| Asturias | No localizado | No consta | No consta | No consta | No |
| Baleares | Protocolo de derivación directa de la Gerencia de Atención Primaria de Mallorca [@C4] | 2023 | Sí | Sí, para doce patologías | No |
| Canarias | Guía de actuación de la consulta de fisioterapia en AP del Servicio Canario de la Salud [@C5; @C5n] | 2022 | Sí | Sí | No |
| Cantabria | No localizado | No consta | No consta | No consta | No |
| Castilla-La Mancha | Guía de Unidades de Fisioterapia de AP del SESCAM [@C7] | 2022 | Sí | Sí, también desde pediatría | No |
| Castilla y León | Protocolos de fisioterapia en AP de la Junta de Castilla y León [@C8] | 2017 | Sí | Sí | No |
| Cataluña | Programa de incorporación de fisioterapeutas y plan funcional del Departament de Salut [@C9b; @C9] | 2023 | Sí, en cada equipo de AP | Sí, dentro del equipo | No consta |
| Comunidad Valenciana | Cartera de servicios de Atención Primaria Comunitaria de la Conselleria de Sanitat [@C10] | 2022 | Sí | No consta | No |
...
El Servicio Canario de la Salud dispone desde 2022 de una guía de actuación de la consulta de fisioterapia en AP [@C5]. El despliegue comenzó en 24 zonas básicas de Gran Canaria, Fuerteventura, Lanzarote y Tenerife, según la nota oficial del Gobierno de Canarias [@C5n]. El modelo se basa en la valoración individual, el plan personalizado, la educación sanitaria y el ejercicio terapéutico [@C5n]. Incluye procesos como la gonartrosis, la coxartrosis, el dolor lumbar y cervical persistente, la epicondilitis y la EPOC leve estable [@C5n].
...
La dotación también difiere en más de diez veces entre comunidades autónomas [@B7]. Una persona con el mismo proceso puede recibir, por tanto, una atención muy distinta según su lugar de residencia. Esta desigualdad es el argumento principal para un modelo homogéneo en todo el SNS.
