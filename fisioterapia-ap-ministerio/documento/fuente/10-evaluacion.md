...
{{TABLA_INDICADORES_RESULTADOS}}

Fuente: anexo B.

La mayoría de los estándares de resultados se fijan tras un año de línea basal, porque no existe un dato español previo. Para la reconsulta existe una referencia externa: el 78,5 % de las personas atendidas por fisioterapia de primer contacto en el Reino Unido no volvió a consultar en doce semanas [@E15]. El indicador IR-10 no tiene estándar, porque la evidencia sobre la reducción de consultas médicas es heterogénea (sección 4.4). El indicador IR-11 mide la demora en rehabilitación hospitalaria solo como resultado del circuito de continuidad, no como criterio de dotación.

El indicador IR-13 mide la adecuación de las derivaciones de medicina de familia a traumatología que siguen a una valoración de fisioterapia de AP. Su referencia externa procede del triaje musculoesquelético: una revisión encontró tasas de conversión quirúrgica del 55 % al 91 % con triaje por fisioterapia, frente al 22 % al 38 % sin él [@E106]. El modelo de este documento no incluye ese triaje, de modo que la referencia solo orienta el estándar. En España, un estudio de 6.225 solicitudes de consulta de AP con traumatología ofrece un punto de comparación sobre la calidad de las derivaciones actuales [@E103].

El indicador IR-14 mide la seguridad del acceso directo. Las revisiones no han encontrado eventos adversos graves atribuibles a esta vía [@E16; @E22; @E24]. La ausencia de datos españoles obliga, sin embargo, a vigilarla desde el primer día. Por eso el indicador revisa cada caso y no fija un estándar numérico. Su registro exige notificar los incidentes en el sistema de seguridad del paciente de cada servicio de salud.
