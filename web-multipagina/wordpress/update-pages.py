...
wpautop_fix = (
    ...
    '.rfw a.rfw-btn--light, .rfw a.rfw-btn--light:visited{color:var(--ink) !important}\n'
    '.rfw a.rfw-btn--out, .rfw a.rfw-btn--out:visited{color:#fff !important}\n'
    '/* — barras laterales azules que Divi pone a los blockquote: blancas sobre bandas de color — */\n'
    '.rfw blockquote{border-left:4px solid #fff !important}\n'
    '/* — titulares en bandas oscuras/de color (Divi fuerza color oscuro en h1-h3) — */\n'
    '.rfw-cta h2, .rfw-cta h3, .rfw-dark h2, .rfw-dark h3, .rfw-dark h4,\n'
    '.rfw-break h2, .rfw-break h3, .rfw-break blockquote{color:#fff !important}\n'
